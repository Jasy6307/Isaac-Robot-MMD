...
def main() -> None:
    ...
    foot_ik_cfg = foot_ik_config_from_namespace(args, groove_pos_to_world=float(args.groove_pos_to_world))
    foot_ik_viz_cfg = foot_ik_viz_config_from_namespace(args)
