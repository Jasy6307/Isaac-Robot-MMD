...
G1_JOINT_AXIS_MAP_RAW: dict[str, AxisMapRawEntry] = {
    # 手臂（肩部：先组合 肩+腕 四元数）
    "left_shoulder_pitch_joint": (["左肩", "左腕"], 1, -1.5),
    "left_shoulder_roll_joint": (["左肩", "左腕"], 2, 1.5),
    "left_shoulder_yaw_joint": (["左肩", "左腕"], 0, 1.5),
    "left_elbow_joint": ("左ひじ", 1, -1.0),
    "left_wrist_pitch_joint": ("左手首", 0, 1.0),
    "left_wrist_roll_joint": ("左手首", 1, 1.0),
    "left_wrist_yaw_joint": ("左手首", 2, 1.0),
    "right_shoulder_pitch_joint": (["右肩", "右腕"], 1, 1.5),
    "right_shoulder_roll_joint": (["右肩", "右腕"], 2, 1.5),
    "right_shoulder_yaw_joint": (["右肩", "右腕"], 0, -1.5),
