...
路径均**相对于本目录** `media/`。  
例如在配置里写 `dance/my_motion.h5`，对应文件为 `media/dance/my_motion.h5`。
...
python source/train_workflow/scripts/vmd_2_csv.py \
  --input media/dance/your_motion.vmd \
  --output media/dance/your_motion.csv
```
