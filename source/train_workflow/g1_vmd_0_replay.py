...
启动：``python source/train_workflow/g1_vmd_0_replay.py``
"""
...
from source.paths import DANCE_DIR, MEDIA_DIR, POSE_DIR

_MEDIA_DIR = MEDIA_DIR

from isaaclab.app import AppLauncher

from source.train_workflow.utils.playback.cli import (
...
from source.train_workflow.utils.motion.sync import sync_dance_assets_from_vmd
...
import source.my_task  # noqa: F401
...
from source.my_task.robots.actuator_pd import (
...
from source.train_workflow.ui.jointRPY_maping_ui import create_joint_rpy_mapping_ui
...
from source.train_workflow.utils.motion.loader import (
    MotionBundle,
...
from source.train_workflow.utils.playback.recorder import PlaybackH5Recorder
from source.train_workflow.utils.playback.root_z import (
    RootZEditConfig,
...
from source.train_workflow.utils.math.trans_util import (
    dist3,
...
def main():
    ...
    from source.my_task.g1_replay_env_cfg import G1_TPOSE_INIT_STATE
