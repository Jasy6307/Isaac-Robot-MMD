...
from source.my_task.mdp.actions import (
    ReferenceResidualJointPositionAction,
    ReferenceResidualJointPositionActionCfg,
)
from source.paths import DANCE_DIR

from source.my_task.mdp.joint_groups import (
...
DEFAULT_DANCE_H5 = os.path.join(DANCE_DIR, "you_are_important.h5")
...
class C1EventCfg(EventCfg):
    ...
    reset_robot_joints = EventTerm(
        ...
        params={
            ...
            "auto_motion_start_weight": False,
